...
class TestFunctionDecorator:
    ...
    def test_log_function_call_auto_logger(self):
...
class TestConvenienceFunctions:
    ...
    @patch('ebm.core.logging.logger')
    def test_metrics(self, mock_logger):
...
class TestSetupLogging:
    ...
    def test_setup_logging_defaults(self, mock_config_class):
    ...
    @patch('ebm.core.logging.LogConfig')
    def test_setup_logging_custom(self, mock_config_class):
