...
from ..core.logging import LoggerMixin, logger
from ..models.base import EnergyBasedModel, LatentVariableModel
from ..sampling.mcmc import AnnealedImportanceSampling
...
class PartitionFunctionEstimator(nn.Module, LoggerMixin):
    ...
    def estimate(self, **kwargs) -> Union[float, Tuple[float, float, float]]:
...
class AISEstimator(PartitionFunctionEstimator):
    ...
    def estimate(
        self,
        base_log_z: Optional[float] = None,
